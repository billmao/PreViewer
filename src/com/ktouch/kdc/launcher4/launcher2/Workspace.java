...
import com.ktouch.kdc.launcher4.launcher2.LauncherSettings.Favorites;
...
public class Workspace extends SmoothPagedView
    ...
    protected void screenScrolled(int screenCenter) {
    	Log.v("maobo","Workspace screenScrolled"+screenCenter);
    ...
    protected void onDraw(Canvas canvas) {
		...
		int temp =getScrollX() + getMeasuredWidth();
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    //bill add begin
    public Bitmap getWorkSpaceBitmap(Launcher launcher){
