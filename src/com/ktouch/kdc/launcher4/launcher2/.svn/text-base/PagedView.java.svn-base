...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    	Log.v("maobo","getChildCount"+getChildCount());
    	Log.v("maobo","PagedView OnMeasure getChildOffset"+getChildOffset(getChildCount()-1));
        Log.v("maobo","getRelativeChildOffset(childCount - 1)"+getRelativeChildOffset(getChildCount() - 1));
        if (!mIsDataReady) {
        ...
        if (childCount > 0) {
            ...
            Log.v("maobo","PagedView OnMeasure mMaxScrollX"+mMaxScrollX);
            Log.v("maobo","PagedView OnMeasure getChildOffset"+getChildOffset(childCount -1));
            Log.v("maobo","getRelativeChildOffset(childCount - 1)"+getRelativeChildOffset(childCount - 1));
        } else {
            mMaxScrollX = 0;
        }
    }
    ...
    protected void screenScrolled(int screenCenter) {
    	Log.v("maobo","screenScrolled222222");
    ...
    protected void dispatchDraw(Canvas canvas) {
    	Log.v("maobo","dispatchDraw PagedVIew");
        ...
        if (screenCenter != mLastScreenCenter || mForceScreenScrolled) {
        	Log.v("maobo","screenCenter !=mLastScreenCenter");
            ...
            if (leftScreen != -1 && rightScreen != -1) {
                ...
                for (int i = getChildCount() - 1; i >= 0; i--) {
                    ...
                    if (mForceDrawAllChildrenNextFrame ||
                    	...
                    	Log.v("maobo","mForceDrawAllChildNextFrame v"+v.toString());
    ...
    //Log.e("maobo","PagedView>>>onInterceptTouchEvent");
        /*
