...
public class WorkspaceCustomizeTabHost extends TabHost implements LauncherTransitionable,
        TabHost.OnTabChangeListener  {
    static final String LOG_TAG = "WorkspaceCustomizeTabHost";

    private static final String APPS_TAB_TAG = "APPS";
    private static final String WIDGETS_TAB_TAG = "WIDGETS";
	private static final String WALLPAPER_TAB_TAG = "WALLPAPER";

    private final LayoutInflater mLayoutInflater;
    private ViewGroup mTabs;
    private ViewGroup mTabsContainer;
    private WorkspaceCustomizePagedView mAppsCustomizePane;
    ...
    public WorkspaceCustomizeTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * tabs manually).
     */
    void setContentTypeImmediate(WorkspaceCustomizePagedView.ContentType type) {
    ...
    void selectAppsTab() {
        setContentTypeImmediate(WorkspaceCustomizePagedView.ContentType.Applications);
    }
    void selectWidgetsTab() {
        setContentTypeImmediate(WorkspaceCustomizePagedView.ContentType.Widgets);
    }
    ...
    protected void onFinishInflate() {
        ...
        final WorkspaceCustomizePagedView appsCustomizePane = (WorkspaceCustomizePagedView)
                findViewById(R.id.workspace_customize_pane_content);
        mTabs = tabs;
        mTabsContainer = tabsContainer;
        mAppsCustomizePane = appsCustomizePane;
        mAnimationBuffer = (FrameLayout) findViewById(R.id.animation_buffer);
        mContent = (LinearLayout) findViewById(R.id.workspace_customize_content);
	...
	//wallpaper
	 label = getContext().getString(R.string.kt_wallpaper_tab_label);
        tabView = (TextView) mLayoutInflater.inflate(R.layout.tab_widget_indicator, tabs, false);
        tabView.setText(label);
        tabView.setContentDescription(label);
        addTab(newTabSpec(WALLPAPER_TAB_TAG).setIndicator(tabView).setContent(contentFactory));
    ...
    private void onTabChangedEnd(WorkspaceCustomizePagedView.ContentType type) {
       // mAppsCustomizePane.setContentType(type);
    }

    @Override
    public void onTabChanged(String tabId) {
        final WorkspaceCustomizePagedView.ContentType type = getContentTypeForTabTag(tabId);
    ...
    public void setCurrentTabFromContent(WorkspaceCustomizePagedView.ContentType type) {
        setOnTabChangedListener(null);
        setCurrentTabByTag(getTabTagForContentType(type));
        setOnTabChangedListener(this);
    }
     ...
     */
    public WorkspaceCustomizePagedView.ContentType getContentTypeForTabTag(String tag) {
        if (tag.equals(APPS_TAB_TAG)) {
            return WorkspaceCustomizePagedView.ContentType.Applications;
        } else if (tag.equals(WIDGETS_TAB_TAG)) {
            return WorkspaceCustomizePagedView.ContentType.Widgets;
        }
        return WorkspaceCustomizePagedView.ContentType.Applications;
    }
     ...
     */
    public String getTabTagForContentType(WorkspaceCustomizePagedView.ContentType type) {
        if (type == WorkspaceCustomizePagedView.ContentType.Applications) {
            return APPS_TAB_TAG;
        } else if (type == WorkspaceCustomizePagedView.ContentType.Widgets) {
    ...
    Log.e("maobo","onLauncherTransitionEnd...");
