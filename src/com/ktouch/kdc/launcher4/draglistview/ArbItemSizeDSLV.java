...
public class ArbItemSizeDSLV extends ListActivity {
    ...
    private String[] mArtistNames={"mArtistNamesprivate1","mArtistNamesprivate2","mArtistNamesprivate3"};
    private String[] mArtistAlbums={"mArtistAlbums1","mArtistAlbums2","mArtistAlbums3"};
