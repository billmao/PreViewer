...
public class Launcherl extends ListActivity {
    ...
    private String[] mActTitles= {"mActTitles1","mActTitles2","mActTitles3"};
    private String[] mActDescs= {"mActDescs1","mActDescs2","mActDescs3"};
...
//        mActDescs = getResources().getStringArray(R.array.activity_descs);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
	    ...
	    Log.v("lianglei", mActivities.get(position).name);
	    startActivity(intent);
    }

    private class MyAdapter extends ArrayAdapter<ActivityInfo> {
      MyAdapter() {
        super(Launcherl.this, R.layout.launcher_item, R.id.activity_title, mActivities);
      }
