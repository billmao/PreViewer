...
import com.ktouch.kdc.launcher4.settings.GallerySettings;
import com.ktouch.kdc.launcher4.ui.ActionModeHandler;
import com.ktouch.kdc.launcher4.ui.ActionModeHandler.ActionModeListener;
import com.ktouch.kdc.launcher4.ui.AlbumSetView;
...
import com.ktouch.kdc.launcher4.ui.GridDrawer;
import com.ktouch.kdc.launcher4.ui.HighlightDrawer;
import com.ktouch.kdc.launcher4.ui.PositionProvider;
...
import com.ktouch.kdc.launcher4.ui.StaticBackground;
...
public class AlbumSetPage extends ActivityState implements
    ...
    private final GLView mRootPane = new GLView() {
        ...
        protected void onLayout(
            ...
            Log.v("billmao","AlbumSetPage onLayout 111 "+SlotView.factor);
            mAlbumSetView.layout(0, slotViewTop, (int)(slotViewRight), slotViewBottom);
        ...
        protected void render(GLCanvas canvas) {
            ...
            Log.v("billmao","AlbumSetPage onLayout render"+SlotView.factor);
    ...
    public void onSingleTapUp(int slotIndex) {
        ...
        if (mShowDetails) {
            ...
            if (mGetAlbum && targetSet.isLeafAlbum()) {
                ...
                intent.putExtra("bucket",  targetSet.getName());
                intent.putExtras(data);
                intent.setClass(mActivity.getAndroidContext(), AlbumSelectTempleteActivity.class);
    ...
    public void onSelectionModeChange(int mode) {
        ...
        switch (mode) {
            ...
            case SelectionManager.LEAVE_SELECTION_MODE: {
                //mActionMode.finish();  //bill delete
                if (mShowClusterMenu) {
