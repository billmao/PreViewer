 ...
 */
@SuppressLint("NewApi") public class CameraManager {
    ...
    public interface PreviewPauseListener {
         ...
         * This allows the Gallery to display an animation when the preview
         * has to stop.
         */
            ...
            new Thread() {
                public void run() {
                    try {
                        ...
                        Gallery.notify("Unable to take picture", 1000);
                    }
                }
            }.start();
        }
    ...
    public void startVideoRecording() {
        ...
        try {
            ...
            Gallery.notify("Error while starting recording", 1000);
        }
        mPreview.postCallbackBuffer();
    }
        ...
        new Thread() {
            public void run() {
                synchronized (mParametersSync) {
                    ...
                    if (mode == Gallery.CAMERA_MODE_VIDEO) {
                        if (!mIsRecordingHint) {
                    ...
                    if (mode == Gallery.CAMERA_MODE_PANO) {
                    ...
                    if (mode == Gallery.CAMERA_MODE_PICSPHERE) {
