...
import com.ktouch.kdc.launcher4.camera.feats.AutoPictureEnhancer;
import com.ktouch.kdc.launcher4.camera.feats.PixelBuffer;
import com.ktouch.kdc.launcher4.camera.widgets.SimpleToggleWidget;
...
public class SnapshotManager {
    ...
    private Camera.PictureCallback mJpegPictureCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] jpegData, Camera camera) {
            ...
            int orientation = Gallery.getCameraMode() == Gallery.CAMERA_MODE_PANO ? 0 :
                    ...
                    new Thread() {
                        public void run() {
                            ...
                            try {
                                ...
                                Gallery.notify("Auto-enhance failed: Original shot saved", 2000);
                            }
                                ...
                                Gallery.notify("Error: Out of memory. Original shot saved", 2000);
                            }
                        }
                    }.start();
                } else {
    ...
    public void removemSnapshotsQueue() {
    	for(int i=0;i<mSnapshotsQueue.size();i++){
    		mSnapshotsQueue.remove(0);
    	}
    }
    ...
    public void queueSnapshot(boolean save, int exposureCompensation) {
        ...
        Log.e("scroll", "队列的数量是： "+mSnapshotsQueue.size());
