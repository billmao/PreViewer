...
package com.ktouch.kdc.launcher4.camera.pano;
...
import com.ktouch.kdc.launcher4.camera.Storage;
 ...
 */
@SuppressLint("NewApi") public class MosaicProxy extends CaptureTransformer
    ...
    public MosaicProxy(Gallery activity) {
    ...
    @SuppressLint("NewApi") private void configMosaicPreview() {
    ...
    public void saveHighResMosaic() {
        Gallery.notify(mActivity.getString(R.string.pano_panorama_rendering), 3000);
        runInBackground(new Thread() {
            @Override
            public void run() {
