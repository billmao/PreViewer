...
import com.ktouch.kdc.launcher4.camera.CameraCapabilities;
...
public class SettingsWidget extends WidgetBase {
            ...
            builder.setPositiveButton(mContext.getString(R.string.ok),
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (Gallery.getCameraMode() == Gallery.CAMERA_MODE_PHOTO
                            || Gallery.getCameraMode()
                            == Gallery.CAMERA_MODE_PICSPHERE) {
                        // Set picture size
    ...
    public SettingsWidget(Gallery context, CameraCapabilities capabilities) {
        ...
        if (Gallery.getCameraMode() == Gallery.CAMERA_MODE_PHOTO
                || Gallery.getCameraMode() == Gallery.CAMERA_MODE_PICSPHERE) {
...
//                        .get(0).width+"x"+mResolutions.get(0).height);
        ...
        if (Gallery.getCameraMode() != Gallery.CAMERA_MODE_PICSPHERE) {
    ...
    public boolean isSupported(Camera.Parameters params) {
        int mode = Gallery.getCameraMode();

        return (mode == Gallery.CAMERA_MODE_PHOTO || mode == Gallery.CAMERA_MODE_VIDEO
                || mode == Gallery.CAMERA_MODE_PICSPHERE);
    }
