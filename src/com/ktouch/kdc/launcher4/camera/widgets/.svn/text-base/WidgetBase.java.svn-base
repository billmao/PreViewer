...
import com.ktouch.kdc.launcher4.camera.BitmapFilter;
...
import com.ktouch.kdc.launcher4.camera.ui.CenteredSeekBar;
 ...
 */
@SuppressLint("NewApi") public abstract class WidgetBase {
        ...
        private class LongClickListener implements OnLongClickListener {
            ...
            public boolean onLongClick(View view) {
                ...
                if (mHintText != null && !mHintText.isEmpty()) {
                    Gallery.notify(mHintText, 2000, getX(), Util.getScreenSize(null).y
                            - getHeight() - getBottom());
                }
    ...
    public class WidgetOptionButton extends Button implements WidgetOption,
        ...
        public boolean onLongClick(View view) {
            if (mHintText != null && mHintText.length() > 0) {
                Gallery.notify(mHintText, 2000, Util.dpToPx(getContext(), 8)
