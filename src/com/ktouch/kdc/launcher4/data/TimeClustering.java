...
public class TimeClustering extends Clustering {
    ...
    private static final long MIN_CLUSTER_SPLIT_TIME_IN_M = 1L;
    // Disregard a cluster split time of anything over 2 hours.
    //bill modify begin
    //private static final long MAX_CLUSTER_SPLIT_TIME_IN_MS = 7200000L;
    private static final long MAX_CLUSTER_SPLIT_TIME_IN_M = 999999999999999999L;
...
//    private static final int MAX_MAX_CLUSTER_SIZE = 50;
    private static final int MIN_MIN_CLUSTER_SIZE = 8000;
    private static final int MAX_MIN_CLUSTER_SIZE = 9000;

    // Try and split a cluster if it is bigger than max cluster size.
    // The max cluster size can range from 20 to 50.
    private static final int MIN_MAX_CLUSTER_SIZE = 10000;
    private static final int MAX_MAX_CLUSTER_SIZE = 100000;
    //bill modify end
    ...
    private long mClusterSplitTime =
            (MIN_CLUSTER_SPLIT_TIME_IN_M + MAX_CLUSTER_SPLIT_TIME_IN_M)*60000 / 2;
    ...
    private void setTimeRange(long timeRange, int numItems) {
        ...
        mClusterSplitTime = Utils.clamp(mClusterSplitTime, MIN_CLUSTER_SPLIT_TIME_IN_M*60000, MAX_CLUSTER_SPLIT_TIME_IN_M*60000);
