...
import com.ktouch.kdc.launcher4.ui.AlbumSetView.AlbumSetItem;
...
import com.ktouch.kdc.launcher4.util.MediaSetUtils;
    ...
    private class LabelDisplayItem extends DisplayItem {
        ...
        public boolean updateContent() {
            ...
            mTextureTitle = StringTexture.newInstance(
                    ...
                    mBoxWidth - s.leftMargin-90, false);
        ...
        public int render(GLCanvas canvas, int pass) {
            ...
            AlbumSetView.LabelSpec s = mLabelSpec;
            int x = -mBoxWidth / 2;
            x += mHasIcon ? s.iconSize:0;  //bill add
            ...
            //mBoxWidth - s.leftMargin-40字符串长度
            x += s.leftMargin+(mBoxWidth - s.leftMargin-110);
            //bill end
