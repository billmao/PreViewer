...
import com.ktouch.kdc.launcher4.anim.CanvasAnimation;
...
public class GLView {
    ...
    protected boolean dispatchTouchEvent(MotionEvent event) {
    	Log.v("billmao","dispatchTouchEvent1111111 "+event.getAction());
    ...
    public void layout(int left, int top, int right, int bottom) {
        ...
        Log.v("billmao","AlbumActivity.factor"+SlotView.factor);
        if (sizeChanged) {
            mViewFlags &= ~FLAG_LAYOUT_REQUESTED;
            onLayout(true, (int)(left/factor), (int)(top), (int)(right/factor), (int)(bottom));
