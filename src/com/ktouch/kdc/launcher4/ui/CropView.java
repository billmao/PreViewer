...
public class CropView extends GLView {
    ...
    private static final int COLOR_OUTLINE = 0xFFFFFFFF;//0xFF008AFF;
    ...
    private class HighlightRectangle extends GLView {
        ...
        private StringTexture mTexturem;
        ...
        private void drawHighlightRectangle(GLCanvas canvas, RectF r) {
            ...
            if (mSpotlightRatioX == 0 || mSpotlightRatioY == 0) {
                ...
                mTexturem = StringTexture.newInstance((int)r.width()+"X"+(int)r.height(), 50, Color.WHITE);
                mTexturem.draw(canvas, (int)r.left+(int)r.width()/2-mTexturem.mWidth/2, (int)r.top+(int)r.height()/2-mTexturem.mHeight/2);
            } else {
                ...
                mTexturem = StringTexture.newInstance(sx+"X"+sy, 50, Color.WHITE);
                mTexturem.draw(canvas, (int)r.left/2, (int)r.top/2);
            }
