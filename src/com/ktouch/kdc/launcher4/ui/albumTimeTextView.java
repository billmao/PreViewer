...
//bill create
public class albumTimeTextView extends TextView {
    ...
    public albumTimeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public albumTimeTextView(Context context, AttributeSet attrs, int defStyle) {
